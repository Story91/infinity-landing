...
function TeamSection2() {
  ...
  const team = [
    ...
    { name: 'Tomasz Pędzierski', title: 'Co-Founder', handle: 'bizdev', avatar: '/images/tomasz-pedzierski-nobg.png', bio: 'Współzałożyciel Infinity Tech, buduje relacje z klientami enterprise i rozwija nowe partnerstwa biznesowe.', glow: matteGlow, gradient: matteGradient, avatarStyle: { width: '110%', objectPosition: '50% 5%' } },
