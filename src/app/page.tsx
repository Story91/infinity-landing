...
function TeamSection2() {
  ...
  const team = [
    ...
    { name: 'Tomasz Pędzierski', title: 'Co-Founder', handle: 'bizdev', avatar: '/tomasz3.png', bio: 'Współzałożyciel Infinity Tech, buduje relacje z klientami enterprise i rozwija nowe partnerstwa biznesowe.', glow: matteGlow, gradient: matteGradient, avatarStyle: { width: '309%', height: '266%', bottom: '-112%', objectPosition: 'center 5%' } },
